...
import { ENTITY_CODIGO_PRODUTO, reserveNextCodigo } from "../../sequencias/entidadeCodigoService.js";
...
export const produtoRepository = {
  ...
  async create(scope, payload) {
    ...
    return prisma.$transaction(async (tx) => {
      const codigo = await reserveNextCodigo(tx, scope.clienteId, ENTITY_CODIGO_PRODUTO);
