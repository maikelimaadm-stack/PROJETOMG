  ...
  return (
    <div className="bg-white shadow-none overflow-hidden">
      ...
      <div className={`h-8 flex items-center gap-2 bg-white border-b-[0.5px] ${toolbarLineClass} px-2`}>
        <span className="w-[150px] h-5 px-1.5 rounded-none border border-[#082e53] text-white text-[11px] font-bold uppercase bg-[#082e53] text-center truncate inline-flex items-center justify-center">{badgeLabel}</span>
