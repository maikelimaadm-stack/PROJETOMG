          ...
          <div>
            ...
            {anexos.length === 0 ?
              ...
              <div className="h-7 flex items-center justify-center">
                <Button type="button" variant="ghost" size="icon" className="h-7 w-7 rounded-none border-0 bg-white text-black hover:bg-slate-50 shadow-none" onClick={() => recordId ? deleteMutation.mutate(anexo.id) : onPendingChange?.(pendingAnexos.filter((item) => item.id !== anexo.id))}>
