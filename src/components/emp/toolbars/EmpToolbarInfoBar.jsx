...
export default function EmpToolbarInfoBar({
  ...
  return (
    <div className={`emp-toolbar-info-bar flex h-8 items-center gap-2 border-b border-[#dce3eb] px-2 ${className}`.trim()}>
      ...
      {operationLabel ? (
        <span className="emp-toolbar-operation-badge ml-auto inline-flex h-6 shrink-0 items-center gap-1.5 rounded-md border border-sky-200 bg-white px-2 text-[11px] font-semibold text-[#1a1f26] whitespace-nowrap">
