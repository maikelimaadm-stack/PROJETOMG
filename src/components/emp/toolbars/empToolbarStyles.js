...
export const EMP_TOOLBAR_BTN =
  `emp-toolbar-btn inline-flex h-[24px] w-[24px] shrink-0 items-center justify-center ${EMP_TOOLBAR_BORDER} bg-white text-[#5b6b80] shadow-none hover:bg-sky-50 disabled:opacity-40 disabled:pointer-events-none transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-sky-300`;
...
export const EMP_HEADER_CTRL_BTN =
  `emp-toolbar-btn emp-header-ctrl inline-flex h-[24px] w-[24px] shrink-0 items-center justify-center ${EMP_TOOLBAR_BORDER} bg-white text-[#082e54] shadow-none hover:bg-sky-50 transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-sky-300`;
