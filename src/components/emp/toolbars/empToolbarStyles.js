...
export const EMP_TOOLBAR_BTN =
  `emp-toolbar-btn inline-flex h-[24px] w-[24px] shrink-0 items-center justify-center ${EMP_TOOLBAR_BORDER} ${EMP_TOOLBAR_BTN_BG} text-[#5b6b80] shadow-none hover:bg-[#dde9fb] disabled:opacity-40 disabled:pointer-events-none transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-sky-300`;

export const EMP_TOOLBAR_SEARCH_WRAP =
  `emp-toolbar-search relative flex h-[24px] w-40 md:w-52 shrink-0 items-center ${EMP_TOOLBAR_BORDER} ${EMP_TOOLBAR_BTN_BG} overflow-hidden`;

export const EMP_TOOLBAR_SEARCH_INPUT =
  "emp-toolbar-search-input h-full w-full min-w-0 flex-1 px-2 pr-7 text-[12px] leading-[24px] text-slate-600 bg-transparent outline-none placeholder:text-slate-400";

export const EMP_TOOLBAR_COUNTER =
  `emp-toolbar-counter inline-flex h-[24px] w-auto min-w-[2rem] shrink-0 items-center justify-center ${EMP_TOOLBAR_BORDER} ${EMP_TOOLBAR_BTN_BG} px-2 text-[12px] font-normal tabular-nums text-[#1a1f26]`;
