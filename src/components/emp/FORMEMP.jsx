...
export default function FORMEMP({
  ...
  const dynamicFields = useMemo(() => [
    ...
    { id: "status", name: "status", label: "Ativa", type: "switch", compact: true, render: () => <div className="h-[22px] flex items-center px-1"><ToggleSwitch checked={formData.status !== "Inativa"} onChange={(checked) => handleChange("status", checked ? "Ativa" : "Inativa")} disabled={isReadOnly} checkedClassName="bg-[#fbc108] hover:bg-[#e5ad00]" /></div> },
