...
export default function RateioCentrosCustoSection({ rateios, onChange, centros, valorTotal, required, error }) {
    ...
    <div className="border border-gray-200 rounded-lg">
      <div className={`flex justify-between items-center px-2 h-7 border-b rounded-t-lg ${error ? 'bg-red-50 border-red-300' : 'bg-slate-100 border-gray-200'}`}>
        <span className="font-semibold text-xs text-slate-700">
          Rateio Centro de Custo{required && <span className="text-red-500 ml-0.5">*</span>}
        </span>
