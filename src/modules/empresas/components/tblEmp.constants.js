...
export const VISIBLE_INITIALIZED_KEY = "emp_col_vis_initialized_v1";
...
export const SIZING_MODE_KEY = "emp_col_sizing_mode_v1";
export const DEFAULT_FILTER_MAX_VISIBLE = 5;
export const FILTER_MAX_VISIBLE_KEY = "emp_filter_max_visible_v1";
