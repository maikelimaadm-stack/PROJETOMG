...
export default function FORMEMP({
  ...
  const dynamicFields = useMemo(() => [
    ...
    { id: "razao_social", name: "razao_social", label: "Nome/Razão Social Emp.", type: "text", required: true, errorKey: "razao_social", medium: true, uppercase: true, placeholder: "NOME/RAZÃO SOCIAL" },
