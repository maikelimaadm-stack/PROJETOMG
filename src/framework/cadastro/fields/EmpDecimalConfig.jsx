...
const fieldBoxCls = "h-6 border-[0.5px] border-[#c5ced8] rounded-[2px] bg-white focus-within:border-[#0089e4] transition-colors overflow-hidden [&_input]:h-[22px] [&_input]:border-0 [&_input]:rounded-none [&_input]:shadow-none [&_input]:focus-visible:ring-0 [&_button]:h-[22px] [&_button]:border-0 [&_button]:rounded-none [&_button]:shadow-none";
