 ...
 * @returns {Object}
 */
export function createRuntimeUiImplementationPlanDiagnostics(options = {}) {
  ...
  const core = {
    kind: 'runtime-ui-implementation-plan-diagnostics',
    passive: true,
    ok,
  ...
  return safeCloneGenericModel({ ...core, diagnosticsDigest: uiPlanDigest(core) });
}

export default createRuntimeUiImplementationPlanDiagnostics;
