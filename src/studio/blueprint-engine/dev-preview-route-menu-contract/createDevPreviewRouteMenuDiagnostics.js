 ...
 * @returns {Object}
 */
export function createDevPreviewRouteMenuDiagnostics(options = {}) {
  ...
  const core = {
    kind: 'dev-preview-route-menu-diagnostics',
    passive: true,
    ok,
...
export default createDevPreviewRouteMenuDiagnostics;
