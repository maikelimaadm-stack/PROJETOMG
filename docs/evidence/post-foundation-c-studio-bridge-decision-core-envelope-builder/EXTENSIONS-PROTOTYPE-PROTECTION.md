# Extensions / Prototype Protection
...
Rejeita extensões críticas na source, override de core/digest/version (impossível por construção) e pollution keys (`__proto__`, `constructor`, `prototype`).
