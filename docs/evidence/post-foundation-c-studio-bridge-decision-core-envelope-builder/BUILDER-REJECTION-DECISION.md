...
`ok:false`, `status:core_envelope_rejected`, coreExtracted/identityVerified/coreEnvelopeCreated=false, coreEnvelope null, issues sanitizadas determinísticas, rollbackByNonEmission=true, sem vazamento de stack/cause/path/secret.
