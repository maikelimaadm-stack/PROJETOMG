...
Qualquer exceção inesperada no boundary público (inclusive Proxy malicioso) vira rejeição determinística sanitizada (`BUILDER_UNEXPECTED_EXECUTION_FAILURE`) — nunca o erro/stack/cause/path/source.
