...
The bridge never certifies or self-certifies. A candidate is inert, non-canonical, non-certified metadata. Certification is a future, human-gated, separately-approved slice, and requires a cryptographic digest first.
