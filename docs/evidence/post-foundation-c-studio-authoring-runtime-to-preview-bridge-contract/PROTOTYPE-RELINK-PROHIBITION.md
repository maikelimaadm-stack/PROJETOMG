...
Relink, import, copy and move of the old Studio prototype are all forbidden across 8 forbidden path prefixes (components/shell/designers/pages/navigation/dock/panels/editor). `oldPrototypeImported` = false; static import scans in the test and gate enforce this.
