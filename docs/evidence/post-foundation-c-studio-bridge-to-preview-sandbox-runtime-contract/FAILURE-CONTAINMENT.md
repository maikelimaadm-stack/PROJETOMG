...
atomicConsumerDecisionRequired; partialSandboxDescriptorAllowed=false; sourceMutationAllowed=false; sideEffects=false;
rollbackByNonConsumption=true; unexpectedExceptionsMustFailClosed=true; stack/message/secret leak=false.