...
oldPrototypeImported=false; prototypeRelinkAllowed=false; forbiddenPrototypePaths lista os 8 subtrees antigos do
Studio como denylist. Nenhum import a esses caminhos (verificado por gate/test estatico).