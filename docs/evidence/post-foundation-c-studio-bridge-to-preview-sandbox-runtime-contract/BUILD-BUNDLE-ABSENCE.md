...
Apos build, grep dist por "bridge-to-preview-sandbox-runtime-contract" e
"bridge_to_preview_sandbox_runtime_contract_ready_for_enterprise_audit" retorna ZERO. Nenhum import produtivo (App nao
referencia); tree-shaking/ausencia de import garantem ausencia no bundle.