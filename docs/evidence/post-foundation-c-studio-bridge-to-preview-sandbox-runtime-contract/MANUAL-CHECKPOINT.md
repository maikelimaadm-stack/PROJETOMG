...
manualGateRequired=true; sourceCheckpoint=pr_486_post_merge_deep_enterprise_hardening_audit;
sourceDecision=POST_MERGE_REVALIDATION_PASS_AND_BRIDGE_HARDENING_ENTERPRISE_PASS. authorizesContractDefinition=true;
todo o resto (implementation plan/runtime/mount/UI/App/route/menu/persistence/backend/Prisma/module/certification/
product/realData/permission-tenancy) = false.