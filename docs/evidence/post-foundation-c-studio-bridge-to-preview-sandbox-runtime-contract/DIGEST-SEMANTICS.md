...
recompute_and_compare; reuso do stableSerialize + createDeterministicDigest (FNV-1a internal-identity only).
cryptographicIntegrityProvided=false. targetDescriptorDigestNotCurrentlyPresent=true; futureConsumerMustNotInventIt=true;
