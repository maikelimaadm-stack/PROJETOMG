...
Tupla explicita de versoes reais (bridge/runtime/contract/plan/authoring/previewSandbox/blueprint/consumer).
exactVersionMatchRequired; unknownVersionFailsClosed; downgrade proibido; upgrade nao assumido; sem alias agregado;
sem coercao silenciosa.