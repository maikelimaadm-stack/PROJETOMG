...
issueCode/severity/stage/path/message/deterministic/blocksConsumer/blocksPreviewSandbox. Ordenacao: stage, path,
issueCode, message. Sem silent correction nem permissive fallback. 52 issue codes, unicos.