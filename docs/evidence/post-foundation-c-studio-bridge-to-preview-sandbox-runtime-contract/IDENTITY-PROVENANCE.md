...
O target DESCRIPTOR nao carrega bridgeDecisionDigest (esse vive na DECISAO da ponte). Declarado como
FUTURE-IMPLEMENTATION BLOCKER: o futuro consumer deve receber a decision digest explicitamente e NUNCA sintetiza-la
nem inventar alias. Tres identidades distintas: source bridge decision, target descriptor, future consumer decision.