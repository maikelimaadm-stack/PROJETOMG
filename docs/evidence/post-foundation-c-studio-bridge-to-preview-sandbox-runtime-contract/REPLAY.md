...
sameSource+sameConfig -> mesma decisao/ordem/sandbox descriptor/consumerDecisionDigest. Sem side effects/global
mutable state/ambient clock/randomness/locale/timezone. replayImplemented=false neste slice.