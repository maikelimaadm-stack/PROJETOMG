...
Fail-closed: unknown critical fields/capability flags/unnamespaced extensions rejeitados; namespace+schema exigidos;
duplicate namespace rejeitado; extensao nao pode sobrescrever critical fields/capabilities/versions/digests;
prototype pollution keys (__proto__/constructor/prototype) rejeitadas. Extensao nunca habilita module/product/data/mount/etc.