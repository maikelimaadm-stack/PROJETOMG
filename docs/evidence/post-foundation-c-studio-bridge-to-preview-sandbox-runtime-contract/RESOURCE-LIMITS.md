...
9 dimensoes (descriptorBytes/descriptorFields/payloadFields/layoutSections/relationships/extensions/stringLength/
validationIssues/structureDepth). Cada uma com sourceLimit/consumerLimit/sandboxLimit/reason/issueCode e
stricterConsumerLimitIntentional (consumer <= source). Sem unknown dimension/truncation/partial descriptor.