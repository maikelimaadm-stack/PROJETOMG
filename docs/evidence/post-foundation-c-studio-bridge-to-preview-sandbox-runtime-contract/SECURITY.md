...
failClosed=true; sem eval/dynamic code/timers/filesystem/network/prisma/process.env mutation; sem stack/message/secret
leak. Sem IO real; puramente declaracoes frozen.