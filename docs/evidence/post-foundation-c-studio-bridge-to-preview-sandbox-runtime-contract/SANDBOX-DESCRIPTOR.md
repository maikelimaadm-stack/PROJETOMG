...
Futuro sandbox descriptor (envelope metadata-only, NAO construido neste slice): kind preview_sandbox_metadata_descriptor,
campos de identidade/digest/versao + previewMetadata. Todo targetField existe no contrato real ou e envelope classificado.