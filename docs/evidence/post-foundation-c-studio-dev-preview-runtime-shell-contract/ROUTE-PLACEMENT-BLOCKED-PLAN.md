...
**blocked** metadata. They describe where a runtime shell WOULD live
(`/studio/preview/runtime/<moduleId>`) and where it WOULD appear in navigation, but
...
`requires future approved runtime implementation slice`. Consuming this changes nothing in the
running app.
