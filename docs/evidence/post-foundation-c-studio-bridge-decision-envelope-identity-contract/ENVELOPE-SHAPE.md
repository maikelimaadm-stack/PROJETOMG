...
envelopeKind=bridge_decision_identity_envelope; fields {envelopeKind, envelopeVersion, bridgeDecisionDigest, targetDescriptor,
sourceBridgeDecisionStatus, versoes, synthetic/immutable/metadataOnly, identityVerified=false, sourceDecisionConsumed=false,
targetDescriptorConsumed=false, consumerRuntimeInvoked=false, previewMounted=false, productExposed=false}. Nenhum envelope construido.