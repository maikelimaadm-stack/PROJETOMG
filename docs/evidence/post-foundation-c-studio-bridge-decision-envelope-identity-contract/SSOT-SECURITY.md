...
bridgeDecision/targetDescriptor/envelope nao canonicos; certifiedBlueprintRemainsSsot=true; envelope nao pode certify/publish/register/
generateModule/exposeProduct. Security failClosed; sem eval/timers/fs/network/prisma/env-mutation/leaks.