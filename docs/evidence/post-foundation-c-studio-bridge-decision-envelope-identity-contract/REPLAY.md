...
sameDecision/sameDigestAndDescriptor -> mesmo envelope; cross-instance determinism; mesma ordem de issues; sem side-effects/clock/random/
locale/timezone. replayImplemented=false.