...
6 dimensoes (envelopeBytes/decisionFields/targetDescriptorFields/issues/stringLength/structureDepth) com source/envelope/consumer +
reason + issueCode. Sem unknown dimension/truncation/partial envelope.