...
Core Envelope v2: 12 campos. `identityVerified: false` sempre; synthetic/immutable/metadataOnly true; coreConsumed/consumerRuntimeInvoked/previewMounted/productExposed false; clone + deep-freeze; sem duplicação.
