# Dev-Only Access Policy — Studio Dev Preview Route/Menu Implementation Plan

Part of the HEADLESS, PLAN-ONLY Studio Dev Preview Route/Menu Implementation Plan. devOnly true; production/staging not allowed; requires an explicit future slice, a manual gate, runtime-UI-ready and synthetic-data-only; requiredCheckpoint pre_route_menu_implementation_enterprise_checkpoint.
