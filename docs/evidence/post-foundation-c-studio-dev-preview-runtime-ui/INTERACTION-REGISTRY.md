# Interaction Registry — Studio Dev Preview Runtime UI

Part of the DEV-ONLY, ISOLATED Studio Dev Preview Runtime UI. Every interaction is blocked / no-op safe / metadata only; no real mutation, navigation, submit or save; no real handler created.
