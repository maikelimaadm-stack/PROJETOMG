...
Plans the exact, anchored scope-governance entries a future bridge **implementation** slice would register (subtree/test/gate/docs), with no broad wildcard and no forbidden path. `guardsAltered` = false.
