...
Rollout remains **blocked** until the enterprise checkpoint passes. No production/staging rollout, no product exposure. Rollback is by non-consumption (no external cleanup); reversible.
