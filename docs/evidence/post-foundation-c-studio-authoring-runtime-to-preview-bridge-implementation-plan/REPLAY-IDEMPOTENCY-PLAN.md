...
Plans that the same source handoff yields the same bridge decision, target descriptor and digest, with no replay side effects. `replayIdempotencyImplemented` = false.
