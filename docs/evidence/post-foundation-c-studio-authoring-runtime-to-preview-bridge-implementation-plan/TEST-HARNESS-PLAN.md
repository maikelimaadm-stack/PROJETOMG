...
Plans the deterministic, synthetic-only test harness for the future bridge (18 planned categories, ≥560 planned scenarios). No real data, no network, no persistence. `testHarnessImplemented` = false.
