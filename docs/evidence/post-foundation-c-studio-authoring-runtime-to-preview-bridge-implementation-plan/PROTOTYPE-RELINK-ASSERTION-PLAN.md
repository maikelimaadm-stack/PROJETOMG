# Prototype Relink Assertion Plan
...
Statically asserts the future bridge never relinks/imports/copies/moves the old Studio prototype across 8 forbidden path prefixes (components/shell/designers/pages/navigation/dock/panels/editor). `oldPrototypeImported` = false; static import scans in the test and gate enforce this.
