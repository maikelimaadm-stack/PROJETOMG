...
Plans the 13 fixed-order, deterministic, fail-closed stages. Blocker stops both the bridge and the preview sandbox handoff; no silent auto-correction; no permissive fallback. `validationPipelineImplemented` = false.
