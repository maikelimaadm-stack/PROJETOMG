...
The certified Blueprint Contract remains the canonical **SSOT**. Drafts and candidates are non-canonical. The future bridge may **never** certify, publish, register, generate a module, overwrite the certified blueprint, or bypass certification; no second SSOT is created. Certification requires a future explicit, human-gated slice.
