...
Plans strict shape validation of the future `synthetic_preview_candidate` handoff: 11 critical fields, unknown critical fields rejected, missing critical fields fail closed, no validation side effects. `sourceValidationImplemented` = false.
