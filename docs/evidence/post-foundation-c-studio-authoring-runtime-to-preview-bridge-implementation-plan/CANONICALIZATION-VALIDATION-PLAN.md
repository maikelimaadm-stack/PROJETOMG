# Canonicalization Validation Plan
...
Plans stable, key-ordered, array-order-preserving, locale- and timezone-independent serialization; ambient clock and randomness forbidden. `canonicalizationValidationImplemented` = false.
