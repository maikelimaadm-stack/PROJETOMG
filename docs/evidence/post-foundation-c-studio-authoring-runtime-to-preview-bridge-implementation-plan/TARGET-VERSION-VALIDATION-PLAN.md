# Target Version Validation Plan
...
Plans exact target sandbox version validation: unknown fails closed, downgrade forbidden, upgrade not assumed compatible. `targetVersionValidationImplemented` = false.
