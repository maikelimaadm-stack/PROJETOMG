...
| **4** | `/docs/architecture/MAK-ENGINEERING-PRINCIPLES.md` | **Engineering Principles** — permanent implementation doctrine (D-029) |
| **5** | `/docs/architecture/MAK-PLATFORM-LANGUAGE-STANDARD.md` | **Platform Language Standard** — official nomenclature |
| **6** | `/docs/engineering/PLATFORM-MATURITY-INDEX.md` | **Platform Maturity Index** — strategic dashboard |
| **7** | `/docs/engineering/*` | Living state (CURRENT-STATE, ROADMAP, DECISIONS, etc.) |
| **8** | `scripts/governance-baseline.json` | Machine-enforced baseline (frozen exceptions, forbidden patterns) |
| **9** | CI gates (`scripts/gate-*.mjs`) | Automated verification of Constitution compliance |
| **10** | `/docs/FOUNDATION_GOVERNANCE.md` | Operational guide (subordinate to Constitution — may drift; see TD-015) |
| **11** | Capability catalogs (`docs/*_CATALOG.md`, `docs/*_INVENTORY.md`) | Reference for config engines |
| **12** | Module-local config and metadata | Domain-only definitions |
| **13** | Chat instructions, informal notes, external reports | **Not authoritative** |
...
| **Engineering Principles** | `/docs/architecture/MAK-ENGINEERING-PRINCIPLES.md` |
