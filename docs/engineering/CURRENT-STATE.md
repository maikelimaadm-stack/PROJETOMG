...
**Verified by:** Program 3.5C Enterprise Architecture Remediation (D-062)
...
| **MAK Business Intent Authoring Architecture** | v1.0.0 | `docs/architecture/MAK-BUSINESS-INTENT-AUTHORING-ARCHITECTURE.md` (**D-059** — Resolver impl **authorized**, G304) |
...
| **Program 3 — Studio Intelligence** | P1 — **3.5C Remediation ✅ (D-062, ARCHITECTURE CONSOLIDATED)** · **Program 3.5 Intent Resolver next (G304)** · Business Computed Fields after | [PROGRAM-REGISTRY.md](./PROGRAM-REGISTRY.md) |
...
| Capability | Status |
|------------|--------|
| MAK Studio Shell / Designers | **Foundation frozen ✅** · **Computation + Formula Builder ✅** · **ARCHITECTURE CONSOLIDATED ✅** · **Intent Resolver next (G304)** |
