...
**Verified by:** Program 2.0.8 Studio Architecture Governance (D-035)  
...
| **MAK Studio Architecture** | v1.4.0 | `docs/architecture/MAK-STUDIO-ARCHITECTURE.md` (**D-031**–**D-035**) |
...
|---------|----------|-------|
| **Program 2 — MAK Studio** | P1 — **Foundation closed (2.0.8), 2.1 Shell next** | [Architecture](../architecture/MAK-STUDIO-ARCHITECTURE.md) · [2.1 Shell Brief](./IFM-PHASE-2.1-STUDIO-SHELL-BRIEF.md) |
