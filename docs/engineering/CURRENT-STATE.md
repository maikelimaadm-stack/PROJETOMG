...
**Verified by:** Program 2.3.1 Field Studio Smart Authoring (D-047)  
...
|---------|----------|-------|
| **Program 2 — MAK Studio** | P1 — **2.3.1 Smart Authoring ✅; 2.3.2 Computed/Formula next** | [2.3.1 Report](./IFM-PROGRAM-2.3.1-CERTIFICATION-REPORT.md) · [2.3.2 Brief](./IFM-PHASE-2.3.2-COMPUTED-FORMULA-FIELDS-BRIEF.md) |
...
| Capability | Status |
|------------|--------|
| MAK Studio Shell / Designers | **Field Smart Authoring ✅** (2.3.1, G297) · **Field Studio ✅** (2.3) · **Layout ✅** (2.2) · **2.3.2 Computed/Formula next** |
