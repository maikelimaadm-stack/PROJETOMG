...
**Verified by:** Program 2.3.5 Studio Evaluation Engine (D-051)  
...
|---------|----------|-------|
| **Program 2 — MAK Studio** | P1 — **2.3.5 Evaluation Engine ✅; 2.3.6 Computed/Derived next** | [2.3.5 Report](./IFM-PROGRAM-2.3.5-CERTIFICATION-REPORT.md) · [2.3.6 Brief](./IFM-PHASE-2.3.6-COMPUTED-DERIVED-FIELDS-BRIEF.md) |
...
| Capability | Status |
|------------|--------|
| MAK Studio Shell / Designers | **Evaluation Engine ✅** (2.3.5, G301) · **Type System ✅** (2.3.4) · **Dependency Engine ✅** (2.3.3) · **Expression Engine ✅** (2.3.2) · **2.3.6 Computed/Derived next** |
