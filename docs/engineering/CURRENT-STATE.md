...
**Verified by:** Program 3.8 Business Computed Fields (D-068, G306)
...
| **MAK Enterprise Organization Architecture** | v1.0.0 | `docs/architecture/MAK-ENTERPRISE-ORGANIZATION-ARCHITECTURE.md` (**D-066**) |
| **Business Intent Resolver (impl)** | v1.0.0 | `src/studio/intent/` (**D-067**, G305) |
| **Business Computed Field (impl)** | v1.0.0 | `src/studio/business/` (**D-068**, G306) |
| **Business Asset Authoring Principles** | v1.0.0 | `docs/architecture/MAK-BUSINESS-ASSET-AUTHORING-PRINCIPLES.md` (**D-068**) |
...
| **Governance Registries** | v1.0.0 | [GOVERNANCE-REGISTRY.md](./GOVERNANCE-REGISTRY.md) · [GATE-REGISTRY.md](./GATE-REGISTRY.md) · [SSOT-REGISTRY.md](./SSOT-REGISTRY.md) |
| **Formula Runtime Unification Plan** | v1.0.0 | [FORMULA-RUNTIME-UNIFICATION-PLAN.md](./FORMULA-RUNTIME-UNIFICATION-PLAN.md) (plan only — AD-P0-01/02 resolved) |
| **Architecture Debt Register** | v1.0.0 | `docs/engineering/ARCHITECTURE-DEBT-REGISTER.md` (**P0: 0** · P1: 10) |
...
| **Program 3 — Studio Intelligence** | P1 — **3.8 Business Computed Field ✅ (G306)** · **Program 3.9 Workflow next** | `src/studio/business/` |
...
| `npm run typecheck` | ⚠️ Escopo de PRODUÇÃO (`jsconfig.typecheck.json`) — 2365 diagnósticos em 477 arquivos (TD-016). Vermelho por desenho: mede a dívida sem escondê-la |
...
| `npm run test:lifecycle-security` (backend) | ✅ 32/32 — bateria adversarial do lifecycle: auth, RBAC (ADMIN decide), IDOR cross-tenant, corrida de decisão (P1-03) |
...
| Capability | Status |
|------------|--------|
| MAK Studio Shell / Designers | **Foundation frozen ✅** · **Business Computed Field ✅ (G306)** · **Program 3.9 Workflow next** |
...
See [TECH-DEBT.md](./TECH-DEBT.md) for technical debt and [ARCHITECTURE-DEBT-REGISTER.md](./ARCHITECTURE-DEBT-REGISTER.md) for architectural debt. **P0: all resolved (D-062).** Active P1 items:
...
5. **P1 (arch):** Formula runtime unification — plan approved; implementation Program 3.6 (proposed)
