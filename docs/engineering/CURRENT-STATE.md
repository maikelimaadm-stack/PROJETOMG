...
**Verified by:** Program 2.0.7 Studio Event Architecture (D-034)  
...
| **MAK Studio Architecture** | v1.3.0 | `docs/architecture/MAK-STUDIO-ARCHITECTURE.md` (**D-031**, SDK **D-032**, DS **D-033**, Events **D-034**) |
...
|---------|----------|-------|
| **Program 2 — MAK Studio** | P1 — **Foundation complete (2.0.7), 2.1 Shell ready** | [Architecture](../architecture/MAK-STUDIO-ARCHITECTURE.md) · [2.1 Shell Brief](./IFM-PHASE-2.1-STUDIO-SHELL-BRIEF.md) |
...
| Capability | Status |
|------------|--------|
| MAK Studio Shell / Designers | Not started — **Foundation complete ✅** (SDK + Design System + Events in `src/studio/`) |
