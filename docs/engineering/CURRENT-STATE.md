...
**Verified by:** Program 2.2 Layout Studio Engine (D-042)  
...
|---------|----------|-------|
| **Program 2 — MAK Studio** | P1 — **2.2 Layout Engine ✅; 2.3 Field Studio next** | [2.2 Report](./IFM-PROGRAM-2.2-CERTIFICATION-REPORT.md) · [2.3 Brief](./IFM-PHASE-2.3-FIELD-STUDIO-BRIEF.md) |
...
| Capability | Status |
|------------|--------|
| MAK Studio Shell / Designers | **Layout Studio Engine ✅** (2.2, G291) · `/studio/empresas/layout` · **2.3 Field Studio next** |
