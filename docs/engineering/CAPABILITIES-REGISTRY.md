...
|------------|--------|---|-------|
| **MAK DATA PLATFORM** | Complete (IFM 1C) | 100 | MDP-0..5 certified (D-026) |
| Versioning & Publication | Implemented | 85 | MDP-5 publish engine + CRB |
...
| Metadata Registry (persisted) | Implemented | 80 | MDP-4 frozen; compile via MDP-5 |
