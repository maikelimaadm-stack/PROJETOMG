...
> **Owner topic:** Platform Event Bus L3 vs MMM Event definitions  
...
Separar **Event Bus L3** (Platform Core transport) de **Event objects MMM** (definitions) — incluindo integração Intelligence observacional.
...
| Event Bus L3 | Transport and dispatch |
...
- **Event Bus** — platform infrastructure (L3).
...
Event Bus API L3 versioned separately from MMM Event schema.

---

## Próximos passos

- Program 4.11: Event Bus L3 Platform Core
